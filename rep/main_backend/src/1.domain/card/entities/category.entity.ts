...
export class Category {
  ...
  constructor({
    id, name, created_at = new Date(), updated_at = new Date()
  } : CategoryProps) {
    this.id = idVo(id);
  ...
  getId() : CategoryProps["id"] {return this.id;};
  getName() : CategoryProps["name"] { return this.name; };
  getCreatedAt() : Exclude<CategoryProps["created_at"], undefined> { return this.created_at; };
  getUpdatedAt() : Exclude<CategoryProps["updated_at"], undefined> { return this.updated_at; };
